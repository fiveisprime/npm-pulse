...
~~~sh
# getting the code
git clone git@github.com:nko4/applejacks.git && cd ./applejacks/

# developing
npm install
npm start

# deploying (to http://applejacks.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@applejacks.2013.nodeknockout.com
ssh root@applejacks.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@applejacks.2013.nodeknockout.com
ssh -i ./id_deploy root@applejacks.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/applejacks" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
